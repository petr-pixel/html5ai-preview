/**
 * LandingPageScanner - Analýza landing page pro auto-fill
 * 
 * Funkce:
...
interface LandingPageScannerProps {
...
export function LandingPageScanner({ onApply, onClose }: LandingPageScannerProps) {
          ...
          <div className="flex gap-2">
            ...
            >
              {isScanning ? (
                ...
                <><Sparkles className="w-4 h-4 mr-2" />Skenovat</>
              )}
            </Button>
          </div>
...
export default LandingPageScanner
