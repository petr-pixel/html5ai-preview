...
export function MobilePreview({ creative, onClose }: MobilePreviewProps) {
        ...
        <div className="px-6 py-4 border-b flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">{creative.format.name} • {creative.format.width}×{creative.format.height}</p>
            </div>
          </div>
