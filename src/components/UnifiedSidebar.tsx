...
export function DashboardView() {
  ...
  // Convert creatives object to array
  const creativesArray = Object.values(creatives) as any[]
  
  const stats = [
    { label: 'Kreativy', value: creativesArray.length, icon: Images, color: 'from-blue-500 to-cyan-500' },
    { label: 'Formáty', value: selectedFormats.size, icon: LayoutGrid, color: 'from-purple-500 to-pink-500' },
    { label: 'Tento měsíc', value: creativesArray.filter(c => {
