...
export function NoImageState({ onUpload, onGenerate }: NoImageStateProps) {
  return (
    <div className="flex flex-col items-center justify-center p-12 text-center border-2 border-dashed border-white/20 rounded-2xl bg-white/5 backdrop-blur-sm">
      <div className="w-20 h-20 mb-6 rounded-2xl bg-gradient-to-br from-violet-500/20 to-cyan-500/20 flex items-center justify-center">
      ...
      <div className="flex flex-wrap justify-center gap-4">
        <button
          onClick={onUpload}
          className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 border border-white/20 text-white rounded-xl hover:bg-white/15 transition-all shadow-lg"
        >
        ...
        <button
          onClick={onGenerate}
          className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-violet-500 to-cyan-500 text-white rounded-xl hover:shadow-lg hover:shadow-violet-500/25 transition-all"
        >
      ...
      {/* Tips */}
      <div className="mt-8 p-4 bg-violet-500/10 border border-violet-500/20 rounded-xl text-left max-w-md">
...
export function NoCreativesState({ onStartNew }: NoCreativesStateProps) {
  return (
    <div className="flex flex-col items-center justify-center p-12 text-center">
      <div className="w-20 h-20 mb-6 rounded-2xl bg-gradient-to-br from-cyan-500/20 to-violet-500/20 flex items-center justify-center">
