...
export function SlideshowBuilder() {
  ...
  return (
    <div className="h-full flex flex-col bg-gray-950 text-white">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="bg-gray-800 border-gray-700 rounded-lg px-3 py-1.5 text-sm"
          >
      ...
      {/* Templates dropdown */}
      {showTemplates && (
        <div className="absolute top-14 left-4 right-4 z-50 bg-gray-900 border border-gray-700 rounded-xl p-4 shadow-xl">
          <div className="flex items-center justify-between mb-3">
            <h3 className="font-medium">Vyberte šablonu</h3>
          ...
          <div className="grid grid-cols-5 gap-3">
            {TEMPLATES.map(template => (
              ...
              >
                ...
                <div className="text-xs text-gray-500 mt-2">{template.aspectRatio}</div>
              </button>
            ))}
          </div>
        </div>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 flex flex-col p-4 gap-4">
          {/* Preview Canvas */}
          <div className="flex-1 flex items-center justify-center bg-gray-900 rounded-xl overflow-hidden">
            <div 
          ...
          <div className="flex items-center gap-4 px-2">
            ...
            <div className="flex-1 flex items-center gap-3">
              ...
              />
              <span className="text-sm text-gray-400 w-12">{formatTime(totalDuration)}</span>
            </div>
          ...
          <div className="bg-gray-900 rounded-xl p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs text-gray-500">{slides.length} slidů</span>
              </div>
            </div>
            
            {slides.length === 0 ? (
              <div className="h-24 flex items-center justify-center border-2 border-dashed border-gray-700 rounded-lg">
                <p className="text-gray-500 text-sm">Klikněte na kreativu níže pro přidání</p>
              </div>
            ) : (
              <div className="flex gap-2 overflow-x-auto pb-2">
                {slides.map((slide, index) => (
                  <div
                    key={slide.id}
                    className={cn(
                      "flex-shrink-0 w-32 bg-gray-800 rounded-lg overflow-hidden cursor-pointer transition-all",
                      selectedSlideId === slide.id && "ring-2 ring-orange-500"
                    )}
                    onClick={() => {
                ...
                <button
                  className="flex-shrink-0 w-20 h-24 flex items-center justify-center border-2 border-dashed border-gray-700 rounded-lg hover:border-gray-600 transition-colors"
                  onClick={() => {
          ...
          {/* Available creatives */}
          <div className="bg-gray-900 rounded-xl p-4">
            <h3 className="text-sm font-medium text-gray-300 mb-3">Dostupné kreativy</h3>
            {creativesArray.length === 0 ? (
              <p className="text-gray-500 text-sm">Žádné kreativy v galerii</p>
            ) : (
              <div className="flex gap-2 overflow-x-auto pb-2">
                {creativesArray.filter(c => !c.isVideo).map(creative => (
                  <button
                    ...
                    className="flex-shrink-0 w-20 h-20 bg-gray-800 rounded-lg overflow-hidden hover:ring-2 hover:ring-orange-500 transition-all"
                  >
                    <img
          ...
          {selectedSlide && (
            <div className="p-4 border-b border-gray-800">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-medium">Nastavení slidu</h3>
              ...
              {/* Motion */}
              <div className="mb-4">
                <label className="text-xs text-gray-400 mb-2 block">Efekt pohybu</label>
                <select
              ...
              {/* Transition */}
              <div className="mb-4">
                <label className="text-xs text-gray-400 mb-2 block">Přechod na další</label>
                <select
          ...
          <div className="p-4 border-b border-gray-800">
            <div className="flex items-center justify-between mb-4">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                ...
                />
                <div className="w-9 h-5 bg-gray-700 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-orange-600"></div>
              </label>
            </div>
            ...
            {textOverlay.enabled && (
              <div className="space-y-3">
                ...
                <div>
                  <label className="text-xs text-gray-400 mb-1 block">Subheadline</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="text-xs text-gray-400 mb-1 block">CTA tlačítko</label>
                  <input
                    type="text"
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="text-xs text-gray-400 mb-1 block">Pozice</label>
                    <select
                      value={textOverlay.position}
                      onChange={(e) => setTextOverlay(prev => ({ ...prev, position: e.target.value as any }))}
                      className="w-full bg-gray-800 border-gray-700 rounded-lg px-2 py-1.5 text-sm"
                    >
                  ...
                  <div>
                    <label className="text-xs text-gray-400 mb-1 block">Animace</label>
                    <select
                ...
                <div>
                  <label className="text-xs text-gray-400 mb-1 block">Zobrazit na</label>
                  <select
                    value={textOverlay.showOnSlides}
                    onChange={(e) => setTextOverlay(prev => ({ ...prev, showOnSlides: e.target.value as any }))}
                    className="w-full bg-gray-800 border-gray-700 rounded-lg px-2 py-1.5 text-sm"
                  >
                    <option value="all">Všech slidech</option>
                    <option value="first">Pouze prvním</option>
                    <option value="last">Pouze posledním</option>
                    <option value="first-last">Prvním a posledním</option>
                  </select>
                </div>
                
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="text-xs text-gray-400 mb-1 block">Barva CTA</label>
                    <input
                      type="color"
                  ...
                  <div>
                    <label className="text-xs text-gray-400 mb-1 block">Barva textu</label>
                    <input
                      type="color"
              ...
              {MUSIC_TRACKS.map(track => (
                ...
                >
                  ...
                  <div className="flex-1 text-left">
                    ...
                    <div className="text-xs text-gray-400">{track.mood} • {track.bpm} BPM</div>
                  </div>
                  {selectedTrack?.id === track.id && (
            ...
            <div className="relative">
              ...
              {customAudioUrl && (
                <div className="mt-2 p-2 bg-gray-800 rounded-lg flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-300">Vlastní audio nahráno</span>
                  <button
