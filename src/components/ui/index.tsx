...
// ============================================================================
// TOOLTIP - Jednoduchý tooltip bez Radix
// ============================================================================
...
export function Tooltip({ content, children, side = 'top', className }: TooltipProps) {
  ...
  return (
    ...
    >
      ...
      {show && (
        <div className={cn(
          'absolute z-50 px-2 py-1 text-xs font-medium text-white bg-gray-900 rounded-md shadow-lg whitespace-nowrap pointer-events-none',
...
export function Kbd({ children, className }: KbdProps) {
  return (
    <kbd className={cn(
      ...
      'bg-white/10 border border-white/20 rounded text-white/60',
      className
    )}>
      {children}
    </kbd>
