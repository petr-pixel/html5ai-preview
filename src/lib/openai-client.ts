...
// ============================================================================
// CENOVÉ KONSTANTY (OpenAI API Pricing - Listopad 2025)
// ============================================================================

export const PRICING = {
  // Images - gpt-image-1
  images: {
    '1024x1024': { standard: 0.011, hd: 0.020 },
    '1280x720': { standard: 0.011, hd: 0.020 },
    '720x1280': { standard: 0.011, hd: 0.020 },
    '1536x1024': { standard: 0.016, hd: 0.032 },
    '1024x1536': { standard: 0.016, hd: 0.032 },
  },
...
export async function generateImage(
  ...
  try {
    ...
    const cost = PRICING.images[sizeKey][params.quality] * (params.n || 1)
