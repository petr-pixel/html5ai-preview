...
import { LandingPageScanner } from '@/components/LandingPageScanner'
  ...
  return (
    <div className="flex h-screen bg-slate-900">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* Generator */}
        {currentView === 'quick-mode' && <QuickMode />}
        ...
        {/* Assets */}
        {currentView === 'brand-kit' && renderBrandKits()}
